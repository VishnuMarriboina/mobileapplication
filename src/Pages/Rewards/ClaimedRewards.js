        ...
        <View style={{paddingHorizontal: 20, paddingVertical: 20}}>
          {/* <View style={styles.container}> */}
            ...
            <View style={{flexDirection: 'row'}}>
              <SvgUri
                uri={
                  'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Driver+App/Success.svg'
                }
                height={28}
                width={28}
                fallback={
              ...
              <Text
                style={{fontSize: 20, fontWeight: '800', paddingHorizontal: 20}}
              ...
              renderItem={({item}) => (
                ...
                >
                  ...
                  <View style={styles.textContainer}>
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      ...
                      <TouchableOpacity onPress={() => handleItemPress(item)}>
                        <SvgUri
                          uri={
                            'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Driver+App/info.svg'
                          }
                          height={14}
                          width={14}
                          fallback={
                  ...
                  >
                    <SvgUri
                      uri={
                        'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Driver+App/Successwhite.svg'
                      }
                      height={18}
                      width={18}
                      fallback={
