    ...
    <>
        ...
        <View>
          <View style={styles.profileImageContainerN}>
            <View style={styles.innerImageContainerN}>
              <SvgUri
                uri={
                  'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Consumer_App/profilenavbar.svg'
                }
                height={42}
                width={42}
                fallback={
            ...
            <TouchableOpacity
              ...
              <SvgUri
                uri={
                  'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Consumer_App/edit.svg'
                }
                height={42}
                width={42}
                fallback={
            ...
            <View
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      status?.toLowerCase() === 'active' ? '#22C55E' : 'red',
                  },
                ]}
              />
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <BarCard
            onPress={() => {
              navigation.navigate('FuelRecords');
            }}>
            <View style={styles.Card}>
              <View>
                <SvgUri
          ...
          <BarCard onPress={handleLogout}>
            <View style={styles.Card}>
              <View>
                <SvgUri
                  uri={
                    'https://d3b1cj4ht2fm8t.cloudfront.net/staging/Driver+App/logout.svg'
                  }
                  height={32}
                  width={32}
                  fallback={
